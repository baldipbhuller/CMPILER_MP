...
public class ExpressionParser extends Parser {
	...
	public static class LowPriorContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExpressionVisitor ) return ((ExpressionVisitor<? extends T>)visitor).visitLowPrior(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class HighPriorContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExpressionVisitor ) return ((ExpressionVisitor<? extends T>)visitor).visitHighPrior(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class SignIntContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExpressionVisitor ) return ((ExpressionVisitor<? extends T>)visitor).visitSignInt(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class TopPriorContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExpressionVisitor ) return ((ExpressionVisitor<? extends T>)visitor).visitTopPrior(this);
			else return visitor.visitChildren(this);
		}
	}
